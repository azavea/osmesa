 ...
 */
object HashtagFootprintUpdater extends CommandApp(
  ...
  main = {
    ...
    val changesStartSequenceOpt =
      Opts.option[Int](
        ...
        short = "s",
        metavar = "sequence",
        help = "Minutely diff starting sequence. If absent, the current (remote) sequence will be used."
      ).orNone
    ...
    val changesBatchSizeOpt =
      Opts.option[Int]("changes-batch-size",
        short = "b",
        metavar = "batch size",
    ...
    val changesetsStartSequenceOpt =
      Opts.option[Int](
        ...
        short = "S",
        metavar = "sequence",
        help = "Changeset starting sequence. If absent, the current (remote) sequence will be used."
      ).orNone
    val changesetsEndSequenceOpt =
      Opts.option[Int]("changeset-end-sequence",
        short = "E",
        metavar = "sequence",
        help = "Changeset ending sequence. If absent, this will be an infinite stream."
      ).orNone
    val changesetsBatchSizeOpt =
      Opts.option[Int]("changesets-batch-size",
        short = "B",
        metavar = "batch size",
