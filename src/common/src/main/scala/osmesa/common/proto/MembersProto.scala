...
object MembersProto extends _root_.com.trueaccord.scalapb.GeneratedFileObject {
  ...
  """Chpwcm90b2J1Zi9zcmMvTWVtYmVycy5wcm90byJ2CgdNZW1iZXJzEicKBm1lbWJlchgBIAMoCzIPLk1lbWJlcnMuTWVtYmVyU
  gZtZW1iZXIaQgoGTWVtYmVyEhIKBHR5cGUYASABKAlSBHR5cGUSEAoDcmVmGAIgASgDUgNyZWYSEgoEcm9sZRgDIAEoCVIEcm9sZ
  WIGcHJvdG8z"""
      ).mkString)
